...
const getDbNotices = async () => {
  try {
    ...
    if (res.data.code === 200 && res.data.data && res.data.data.rows) {
      // 格式化时间并只保留前4条
...
const handleUserCommand = (command: string) => {
  if (command === 'profile') {
    router.push('/admin/apersonalcenters')
    ...
    <el-header class="front-header">
      ...
      <div class="nav-menu">
        <el-dropdown @command="handleNavCommand">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="/admin/datas">可视化大屏</el-dropdown-item>
              <el-dropdown-item command="/admin/graph">知识图谱</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
        ...
        <el-dropdown @command="handleNavCommand">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="/admin/books/book">库存管理</el-dropdown-item>
              <el-dropdown-item command="/admin/books/borrow">借阅管理</el-dropdown-item>
              <el-dropdown-item command="/admin/books/return">还书管理</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
        ...
        <el-button 
          type="text" 
          class="nav-item" 
          @click="navigateTo('/admin/readers')"
        >
          读者管理
        </el-button>
        <el-button 
        ...
        <el-button 
          type="text" 
          class="nav-item" 
          @click="navigateTo('/admin/aviolations')"
        >
          违规记录处理
        </el-button>
        <el-button 
          type="text" 
          class="nav-item" 
          @click="navigateTo('/admin/notices')"
        >
          公告管理
        </el-button>
        <el-button 
          type="text" 
          class="nav-item" 
          @click="navigateTo('/admin/knowledge')"
        >
          知识库管理
        </el-button>
              ...
              <div class="notice-item">
                ...
                <div class="notice-right">
                  <div class="notice-header">
                    <!-- 标题点击跳转到公告管理界面 -->
                    <div class="notice-title" @click="navigateTo('/admin/notices')">{{ notice.title }}</div>
